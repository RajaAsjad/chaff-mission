                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="chaff-team-head">
                            <h1><span>JOIN OUR</span>CHAFF TEAM!</h1>
                                <div class="form-ad">
                                    <form action="{{ route('career.store') }}"  id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                        @csrf
                    ...
                    <div class="col-md-6">
                        <div class="chaff-team-image">
                            <img src="{{ asset('public/assets/website') }}/images/career.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="perspiciaties-image">
                            <img src="{{ asset('public/assets/website') }}/images/career-2.png" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">

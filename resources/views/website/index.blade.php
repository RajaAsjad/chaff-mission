            ...
            <div>
                <p class="mb-4">
                    ...
                    <!-- --> <a
                        ...
                        href="#" target="_blank"
                        rel="noreferrer">advertising agency</a>, a
                    <!-- -->
                    <a class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                        href="#" target="_blank" rel="noreferrer">start-up</a>, a
                    <!-- --> <a
                        class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                        href="#" target="_blank"
                        rel="noreferrer">student-led design
                    studio</a>, and a
                    <!-- -->
                    <a class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                        href="#" target="_blank"
                ...
                <p class="mb-4">
                    ...
                    <!-- --> <a
                        class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                        href="#" target="_blank"
                        rel="noreferrer">Upstatement</a>. In my free time I&#x27;ve also released an
                    <!-- --> <a
                        class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                        href="#"
                        target="_blank" rel="noreferrer">online video course</a> <!-- -->that covers
            ...
            <div>
                <ol class="group/list">
                    <li class="mb-12">
                        ...
                        <div class="z-10 sm:col-span-6">
                            ...
                            <p class="mt-2 text-sm leading-normal">Deliver high-quality, robust
                                production code for a
                                diverse array of projects for clients including Harvard Business
                                School, Everytown for Gun
                                Safety, Pratt Institute, Koala Health, Vanderbilt University, The
                                19th News, and more. Provide
                        ...
                        <div class="z-10 sm:col-span-6">
                            <h3 class="font-medium leading-snug text-slate-200">
                                <div>
                                    ...
                                    href="#" target="_blank"
                                    rel="noreferrer"
                                    aria-label="UI Engineer Co-op · Apple">
                                    <span
                            ...
                            <ul class="mt-2 flex flex-wrap" aria-label="Technologies used:">
                                <li class="mr-4">
                                    ...
                                    <svg
                                        ...
                                        fill="currentColor" class="mr-1 h-3 w-3"
                                        aria-hidden="true">
                                        <path
                        ...
                        <div class="z-10 sm:col-span-6">
                            <h3 class="font-medium leading-snug text-slate-200">
                                <div>
                                    ...
                                    href="#"
                                    target="_blank" rel="noreferrer"
                                    aria-label="Developer · Scout Studio">
                                    <span
                                        class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                    <span>
                                        Developer
                            ...
                            <p class="mt-2 text-sm leading-normal">Collaborated with other student
                                designers and engineers
                                on pro-bono projects to create new brands, design systems, and
                                websites for organizations in
                                the community.
                            </p>
                            <ul class="mt-2 flex flex-wrap">
                                <li class="mr-1.5 mt-2">
                        ...
                        <div class="z-10 sm:col-span-6">
                            <h3 class="font-medium leading-snug text-slate-200">
                                <div>
                                    ...
                                    href="#" target="_blank"
                                    rel="noreferrer"
                                    aria-label="Software Engineer Co-op · Starry">
                                    <span
                                        class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                    <span>
                                        Software
                            ...
                            <p class="mt-2 text-sm leading-normal">Worked with the UI team to
                                engineer and improve major
                        ...
                        <div class="z-10 sm:col-span-6">
                            <h3 class="font-medium leading-snug text-slate-200">
                                <div>
                                    ...
                                    href="#" target="_blank"
                                    rel="noreferrer"
                                    aria-label="Creative Technologist Co-op · MullenLowe U.S.">
                                    <span
                                        class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                    <span>
                                        Creative
                                        Technologist Co-op · MullenLowe
                                        <!-- -->
                                        <span class="inline-block">
                                            U.S.
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                                ...
                                                aria-hidden="true">
                                                <path fill-rule="evenodd"
                                                    d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z" clip-rule="evenodd">
                                                </path>
                                            </svg>
                                        </span>
                                    </span>
                            ...
                            <p class="mt-2 text-sm leading-normal">Developed, maintained, and
                                shipped production code for
                                client websites. Clients included JetBlue, Lovesac, U.S. Cellular,
                ...
                <div class="mt-12">
                    <a class="inline-flex items-center font-medium leading-tight text-slate-200 font-semibold text-slate-200 group"
                        aria-label="View Full Résumé" href="{{ asset('public/admin/assets/images/Muhammad Asjad resume.pdf') }}" target="_blank">
                        <span>
                        ...
                        <span class="whitespace-nowrap">
                            <span
                                class="border-b border-transparent pb-px transition group-hover:border-teal-300 motion-reduce:transition-none">Resume</span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor"
                    ...
                    <li class="mb-12">
                        ...
                        <div class="z-10 sm:order-2 sm:col-span-6">
                            ...
                            <p class="mt-2 text-sm leading-normal">
                                ...
                                Spotify Web API. Topics covered include the principles of REST APIs,
                        ...
                        <img alt="" loading="lazy" width="200" height="48" decoding="async" data-nimg="1"
                            ...
                            src="_ipx/w_640%2cq_75/images/projects/course-card0802.png?url=%2Fimages%2Fprojects%2Fcourse-card.png&amp;w=640&amp;q=75" />
                        </div>
                    </li>
                    <li class="mb-12">
                        <div
                        ...
                        <div class="z-10 sm:order-2 sm:col-span-6">
                            <h3>
                                <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 undefined group/link text-base"
                                    href="#" target="_blank"
                                    rel="noreferrer" aria-label="Spotify Profile">
                                    <span class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                        Spotify
                                        <!-- -->
                                    <span class="inline-block">
                            ...
                            <p class="mt-2 text-sm leading-normal">Web app for visualizing
                                personalized Spotify data. View
                                your top artists, top tracks, recently played tracks, and detailed
                                audio information about
                                each track. Create and save new playlists of recommended tracks
                        ...
                        <img alt="" loading="lazy" width="200" height="48"
                            ...
                            src="_ipx/w_640%2cq_75/images/projects/spotify-profileb19d.png?url=%2Fimages%2Fprojects%2Fspotify-profile.png&amp;w=640&amp;q=75" />
                        </div>
                    </li>
                    <li class="mb-12">
                        <div
                        ...
                        <div class="z-10 sm:order-2 sm:col-span-6">
                            <h3>
                                <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 undefined group/link text-base"
                                    href="#" target="_blank"
                                    rel="noreferrer" aria-label="Halcyon Theme">
                                    <span class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                        Halcyon
                                    <!-- -->
                                    <span class="inline-block">
                                        Theme
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                            class="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group-focus-visible/link:-translate-y-1 group-focus-visible/link:translate-x-1 motion-reduce:transition-none ml-1 translate-y-px" aria-hidden="true">
                                            <path fill-rule="evenodd"
                                                d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z" clip-rule="evenodd">
                                            </path>
                                        </svg>
                            ...
                            <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                                href="#"
                                target="_blank" rel="noreferrer" aria-label="Over 100,000 installs on Visual Studio Code Marketplace">
                        ...
                        <img alt="" loading="lazy" width="200" height="48"
                            ...
                            src="{{-- _ipx/w_640%2cq_75/images/projects/halcyond92d.png?url=%2Fimages%2Fprojects%2Fhalcyon.png&amp;w=640&amp;q=75 --}}" />
                        </div>
                    </li>
                    <li class="mb-12">
                        <div class="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <div class="z-10 sm:order-2 sm:col-span-6">
                                <h3>
                                    <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 undefined group/link text-base"
                                        href="#" target="_blank"
                                        rel="noreferrer" aria-label="brittanychiang.com (v4)">
                                        <span
                                        class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                        <span>
                                        brittanychiang.com
                                ...
                                <p class="mt-2 text-sm leading-normal">An old portfolio site built with
                                    Gatsby with 6k+ stars
                                    and 3k+ forks
                                </p>
                                <ul class="mt-2 flex flex-wrap" aria-label="Technologies used:">
                                    <li class="mr-1.5 mt-2">
                            ...
                            <img alt="" loading="lazy" width="200" height="48"
                               ...
                               {{--  srcSet="/_next/image?url=%2Fimages%2Fprojects%2Fv4.png&amp;w=256&amp;q=75 1x, /_next/image?url=%2Fimages%2Fprojects%2Fv4.png&amp;w=640&amp;q=75 2x" --}}
                                src="{{-- _ipx/w_640%2cq_75/images/projects/v49210.png?url=%2Fimages%2Fprojects%2Fv4.png&amp;w=640&amp;q=75 --}}" />
                        </div>
                    </li>
                </ul>
                {{-- <div class="mt-12">
                    <a
                        ...
                        aria-label="View Full Project Archive" href="archive.html">
                        <span>
                        <span
                ...
                <ul class="group/list">
                    <li class="mb-12">
                        ...
                        <img alt="Telescope" loading="lazy" width="200" height="48"
                            ...
                            src="_ipx/w_640%2cq_75/images/writing/algolia-search0dbd.jpg?url=%2Fimages%2Fwriting%2Falgolia-search.jpeg&amp;w=640&amp;q=75" />
                        <div class="z-10 col-span-6">
                            <p class="-mt-1 text-sm font-semibold leading-6">2020</p>
                            <h3 class="-mt-1">
                                <a
                                    class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 undefined group/link text-base"
                    ...
                    <li class="mb-12">
                        ...
                        <img alt="Headless horseamn" loading="lazy" width="200"
                            ...
                            src="_ipx/w_640%2cq_75/images/writing/headlesscfd5.jpg?url=%2Fimages%2Fwriting%2Fheadless.jpeg&amp;w=640&amp;q=75" />
                        <div class="z-10 col-span-6">
                            ...
                            <h3 class="-mt-1">
                                <a
                                    ...
                                    <span>
                                    Building
                                    a Headless Mobile App CMS From
                                    <!-- -->
                                    <span class="inline-block">
                                        Scratch
                                        <svg
            ...
            <div class="container">
                <div class="row">
                    <p class="col-lg-12 text-center">
                        Copyright © <?php echo date("Y"); ?> by
                        <a href="#about">Muhammad Asjad</a>
                    </p>
                </div>
            </div>
        </footer>

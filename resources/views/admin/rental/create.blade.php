...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route('rental.store') }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							<input type="text" autocomplete="off" class="form-control" name="color" value="{{ old('color') }}" placeholder="Enter Color">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="price" autocomplete="off" class="form-control" name="rent" value="{{ old('rent') }}" placeholder="Enter Rent">

				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="heading" value="{{$model->heading}}" placeholder="Enter Heading">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Slug <span style="color:red">*</span></label>
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="slug" value="{{$model->slug}}">
							</div>
						</div>
						<div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <img style="width: 80px " src="{{ asset('public/admin/assets/images/properties') }}/{{ $model->image }}" alt="">
                            </div>
                         </div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							<input type="number" autocomplete="off" class="form-control" name="rating" value="{{ $model->rating }}">
							</div>
						</div>
						<div class="form-group">

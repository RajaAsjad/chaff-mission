...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="{{ route('vehicle.index') }}" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{route('vehicle.update', $model->slug)}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				{{ method_field('PATCH') }}
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <img style="width: 80px " src="{{ asset('public/admin/assets/images/vehicle') }}/{{ $model->image }}" alt="">
                            </div>
                         </div>
						 <div class="form-group">
							<label for="" class="col-sm-2 control-label">Short Description<span style="color: red">*</span></label>
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="short_description" value="{{ $model->short_description }}" placeholder="Enter Short Description">
							</div>
						</div>
						<div class="form-group">

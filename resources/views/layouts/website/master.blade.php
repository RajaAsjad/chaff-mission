...
<head>
   ...
   {{--  <link rel="manifest" href="favicon/site.webmanifest" /> --}}
    ...
    <link rel="preload" href="{{ asset('public/assets/website/_next/static/css/ddee093839f4ecb2.css') }}"
        as="style" />
    <link rel="stylesheet" href="{{ asset('public/assets/website/_next/static/css/ddee093839f4ecb2.css') }}"
        data-n-g="" />
    <noscript data-n-css=""></noscript>
    <script defer="" nomodule="" src="{{ asset('public/assets/website/_next/static/chunks/polyfills-c67a75d1b6f99dc8.js') }}"></script>
    {{-- <script src="{{ asset('public/assets/website/_next/static/chunks/webpack-880e48e2fc817058.js') }}" defer=""></script> --}}
    <script src="{{ asset('public/assets/website/_next/static/chunks/framework-2c79e2a64abdb08b.js') }}" defer=""></script>
    <script src="{{ asset('public/assets/website/_next/static/chunks/main-17a9a24315ee9390.js') }}" defer=""></script>
    <script src="{{ asset('public/assets/website/_next/static/chunks/pages/_app-4bc465e7665e4ac0.js') }}" defer=""></script>
    <script src="{{ asset('public/assets/website/_next/static/chunks/664-09cd891ecc3af1d0.js') }}" defer=""></script>
    <script src="{{ asset('public/assets/website/_next/static/chunks/506-95c309a4d817bb8b.js') }}" defer=""></script>
    <script src="{{ asset('public/assets/website/_next/static/chunks/pages/index-54d4346dea697749.js') }}" defer=""></script>
    <script src="{{ asset('public/assets/website/_next/static/Zir8Nbaki0-5PHTn_Z7Ql/_buildManifest.js') }}" defer=""></script>
    <script src="{{ asset('public/assets/website/_next/static/Zir8Nbaki0-5PHTn_Z7Ql/_ssgManifest.js') }}" defer=""></script>
</head>
...
<body class="bg-slate-900 leading-relaxed text-slate-400 antialiased selection:bg-teal-300 selection:text-teal-900">
  ...
  {{--   <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <!-- home_banner js cdn-->
   {{--  <script id="__NEXT_DATA__" type="application/json">{"props":{"pageProps":{}},"page":"/","query":{},"buildId":"Zir8Nbaki0-5PHTn_Z7Ql","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}</script> --}}

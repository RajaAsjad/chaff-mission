    ...
    <!-- car rent html start -->
        <section class="rent-car">
            <div class="container">
                ...
                <div class="row">
                    <!-- <?php $__currentLoopData = $steprents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $steprent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 rent-menu">
                        <div class="rent-card">
                            <img src="<?php echo e(asset('public/admin/assets/images/car_rent/')); ?>/<?php echo e($steprent->image); ?>" alt="">
                            <h6><?php echo e($steprent->heading); ?></h6>
                            <p><?php echo $steprent->description; ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                    <div class="col-md-3 rent-menu">

								...
								<tr id="id-<?php echo e($model->slug); ?>">
									...
									<td>
										<?php if($model->thumbnail): ?>
											<img src="<?php echo e(asset('public/admin/assets/products/thumbnails/'.$model->thumbnail)); ?>" alt="" style="width:60px;">
										<?php else: ?>
									...
									<td><?php echo e($model->rent_per_day); ?></td>
									<td>
										<?php if($model->status): ?>
									...
									<td>
										...
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-delete')): ?>
                                            <button class="btn btn-danger btn-xs delete" data-slug="<?php echo e($model->slug); ?>" data-del-url="<?php echo e(route('product.destroy', $model->slug)); ?>"><i class="fa fa-trash"></i> Delete</button>
										<?php endif; ?>
									</td>
								</tr>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chaff_mission\resources\views/admin/product/index.blade.php ENDPATH**/ ?>
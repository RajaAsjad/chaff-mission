    ...
    <section class="about-us-sec">
        <div class="container">
            <div class="row about-row-first">
                <div class="col-md-7">
                    <h3><?php echo e($abouts[1]['heading']); ?></h3>
                    <h1><?php echo e($abouts[1]['short_description']); ?></h1>
                    <p><?php echo $abouts[1]['description']; ?></p>
                </div>
                <div class="col-md-5">
                    <div class="about-inner-img">
                        <img src="<?php echo e(asset('public/admin/assets/images/about')); ?>/<?php echo e($abouts[1]['image']); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="row about-row-first flex-row-reverse">
                <div class="col-md-7">
                <h3><?php echo e($abouts[2]['heading']); ?></h3>
                <h1><?php echo e($abouts[2]['short_description']); ?></h1>
                <p><?php echo $abouts[2]['description']; ?></p>
                </div>
                <div class="col-md-5">
                    <div class="about-inner-img">
                        <img src="<?php echo e(asset('public/admin/assets/images/about')); ?>/<?php echo e($abouts[2]['image']); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="row last-para">
                <div class="col-md-12">
                <p><?php echo $abouts[3]['description']; ?></p>
                </div>
            </div>
        </div>
        <!-- <div class="container">
            <div class="row about-row-first">
                ...
                <div class="col-md-5">
                    <div class="about-inner-img">
                        <img src="<?php echo e(asset('public/assets/website')); ?>/images/about-inner1.png" alt="">
                    </div>
                </div>
            </div>
            <div class="row about-row-first flex-row-reverse">
                ...
                <div class="col-md-5">
                    <div class="about-inner-img">
                        <img src="<?php echo e(asset('public/assets/website')); ?>/images/about-inner2.png" alt="">
                    </div>
                </div>
            </div>
            <div class="row last-para">
...
<?php echo $__env->make('layouts.website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chaff_mission\resources\views/website/about.blade.php ENDPATH**/ ?>
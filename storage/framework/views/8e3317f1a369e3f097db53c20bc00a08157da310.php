            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        <h3>MAIL US</h3>
                        <h1>DROP A LINE</h1>
                        <form action="<?php echo e(route('contactus.store')); ?>" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chaff_mission\resources\views/website/contact_us.blade.php ENDPATH**/ ?>
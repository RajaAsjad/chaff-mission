            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="iner-baner-head">
                        <h1>SUBSCRIPTIONS</h1>
                        <p class="extra-text">Home > Subscriptions</p>
...
<?php echo $__env->make('layouts.website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chaff_mission\resources\views/website/subscriptions.blade.php ENDPATH**/ ?>